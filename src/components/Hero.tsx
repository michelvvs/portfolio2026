    ...
    <section className="pt-24 sm:pt-32 pb-8 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
      ...
      <div className="relative group flex-shrink-0">
        ...
        <div className="relative w-52 h-52 sm:w-64 sm:h-64">
          ...
          <div className="w-full h-full rounded-full border-2 border-emerald-400 overflow-hidden bg-[#1d3531] shadow-[0_0_30px_rgba(52,211,153,0.2)]">
            <img
              src={avatarImg}
              alt={data.name}
          ...
          <div className="absolute -bottom-1.5 -right-1.5 sm:bottom-0.5 sm:right-0.5 bg-[#0c0d0e] border-2 border-emerald-400 text-emerald-400 font-mono font-bold text-sm sm:text-base px-2.5 py-0.5 rounded-full shadow-xl flex items-center justify-center tracking-tighter select-none z-10">
            &lt;/&gt;
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4 text-center md:text-left flex-1 min-w-0">
        ...
        <div className="flex flex-wrap items-center justify-center md:justify-start gap-2.5 text-xs font-mono text-neutral-400">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-neutral-900/90 border border-neutral-800 shadow-sm">
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
            </span>
            <span className="text-neutral-300 font-medium">{data.status}</span>
          </div>

          <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-neutral-900/50 border border-neutral-800/80 text-neutral-400">
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-2.5 pt-0.5">
            <span className="text-base sm:text-xl lg:text-2xl font-semibold tracking-tight text-neutral-200">
              {data.hero.rolePrimary}
            </span>
            {data.hero.roleSecondary && (
              <span className="px-2.5 py-0.5 rounded-md bg-emerald-500/15 border border-emerald-500/30 text-emerald-400 font-mono text-xs sm:text-sm font-bold tracking-wide shadow-[0_0_12px_rgba(52,211,153,0.12)]">
                {data.hero.roleSecondary}
              </span>
            )}
          </div>
        ...
        {/* Mini Tech Icons Row */}
        <div className="flex flex-wrap items-center justify-center md:justify-start gap-3.5 py-1 text-neutral-400">
          ...
          <SiNextdotjs className="w-5 h-5 hover:text-white hover:scale-110 transition-all cursor-pointer" title="Next.js" />
